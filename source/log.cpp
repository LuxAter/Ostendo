...
void ostendo::log::Log(int type, std::string msg, std::string func, ...) {
  std::string str;
...
std::string ostendo::log::GetLog(int type) {
  std::string entry;
...
std::pair<int, std::string> ostendo::log::FGetLog(int type) {
...
std::pair<int, std::string> ostendo::log::IFGetLog(int index) {
  std::pair<int, std::string> entry;
  if (index >= 0 && (size_t)index < global_logs.size()) {
...
std::vector<std::pair<int, std::string>> ostendo::log::VFGetLog(int start,
                                                                int end) {
...
void ostendo::log::SetLogHandle(void (*handle)(std::pair<int, std::string>)) {
...
void ostendo::log::SetLogOption(int option, int setting) {
...
std::string ostendo::log::GetTypeStr(int type) {
  std::string str;
  if (type == ERROR) {
    str = "ERROR";
